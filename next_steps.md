...
git branch -M main
git remote add origin git@github.com:ANNUBS/annubes
```

## Push the initial commit to a new repo on GitHub

Go to
[https://github.com/organizations/ANNUBS/repositories/new](https://github.com/organizations/ANNUBS/repositories/new)
and create a new repository named `annubes` as an empty repository, then push your commits to GitHub:
...
automatically ([here](https://github.com/ANNUBS/annubes/issues?q=author%3Aapp%2Fgithub-actions)). Resolve them to complete the
