...
class CustomRNN(nn.Module):
    def __init__(self, input_size, hidden_size, output_size, param):
        ...
        with torch.no_grad():#! just for the multiplication 
            self.h2h.weight[:, :self.n_in] = self.h2h.weight[:, :self.n_in] * 4#!: Why -> avoid breaking of convergence
        ...
        #self.noise = torch.distributions.normal.Normal(0, self.rec_noise_std)
